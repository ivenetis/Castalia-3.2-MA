...
#include "IEMF_MH_PosPkt_m.h"
#include "IEMF_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"IEMF_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"IEMF_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"IEMF_MH END_OF_TURN_PACKET"
#define MA_PACKET			"IEMF_MH MA_PACKET"
...
namespace IEMF_MH_NS {
	...
	class IEMF_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
