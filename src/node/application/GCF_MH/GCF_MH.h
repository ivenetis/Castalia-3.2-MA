...
#include "GCF_MH_PosPkt_m.h"
#include "GCF_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"GCF_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"GCF_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"GCF_MH END_OF_TURN_PACKET"
#define MA_PACKET			"GCF_MH MA_PACKET"
...
namespace GCF_MH_NS {
	...
	class GCF_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
