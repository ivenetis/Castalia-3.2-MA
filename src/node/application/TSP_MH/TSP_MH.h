...
#include "TSP_MH_PosPkt_m.h"
#include "TSP_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"TSP_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"TSP_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"TSP_MH END_OF_TURN_PACKET"
#define MA_PACKET			"TSP_MH MA_PACKET"
...
namespace TSP_MH_NS {
	...
	class TSP_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
