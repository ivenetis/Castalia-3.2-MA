 ...
 */
void LCF_MH::fromNetworkLayer ( ApplicationPacket * genericPacket, const char *source, double rssi, double lqi )
{
...
void LCF_MH::timerFiredCallback ( int index )
{
	switch ( index ) {
...
void LCF_MH::handleSensorReading ( SensorReadingMessage * sensorMsg )
{
...
void LCF_MH::DijkstraDistance ( int source, vector<double> &MinVect, vector<int> &PrevVect )
{
...
void LCF_MH::DijkstraPower ( int source, vector<double> &MinVect, vector<int> &PrevVect )
{
	set<pair<double, int> > vertex_queue;
