...
#include "LCF_MH_PosPkt_m.h"
#include "LCF_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"LCF_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"LCF_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"LCF_MH END_OF_TURN_PACKET"
#define MA_PACKET			"LCF_MH MA_PACKET"
...
namespace LCF_MH_NS {
	...
	class LCF_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
