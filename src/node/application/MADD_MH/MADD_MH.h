...
#include "MADD_MH_PosPkt_m.h"
#include "MADD_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"MADD_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"MADD_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"MADD_MH END_OF_TURN_PACKET"
#define MA_PACKET			"MADD_MH MA_PACKET"
...
namespace MADD_MH_NS {
	...
	class MADD_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
