...
#include "IEMA_MH_PosPkt_m.h"
#include "IEMA_MH_MA_Pkt_m.h"
...
#define REQUEST_POSITIONS_PACKET	"IEMA_MH REQUEST_POSITIONS_PACKET"
#define SEND_POSITION_PACKET		"IEMA_MH SEND_POSITION_PACKET"
#define END_OF_TURN_PACKET		"IEMA_MH END_OF_TURN_PACKET"
#define MA_PACKET			"IEMA_MH MA_PACKET"
...
namespace IEMA_MH_NS {
	...
	class IEMA_MH:public VirtualApplication {
	private:
		double	THRESHOLD;
		double	startTime;
		double	endTime;
