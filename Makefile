...
#  opp_makemake -f -r --deep -o CastaliaBin -u Cmdenv -P /root/Work/Projects/PROSENS/Castalia-3.2-MA -M release -X Simulations -X out -X bin
#
...
INCLUDE_PATH = \
    ...
    -Isrc/node/application/GCF_MH \
    -Isrc/node/application/IEMA_MH \
    -Isrc/node/application/IEMF_MH \
    -Isrc/node/application/LCF_MH \
    -Isrc/node/application/MADD_MH \
...
OBJS = \
    ...
    $O/src/node/application/GCF_MH/GCF_MH.o \
    $O/src/node/application/IEMA_MH/IEMA_MH.o \
    $O/src/node/application/IEMF_MH/IEMF_MH.o \
    $O/src/node/application/LCF_MH/LCF_MH.o \
    $O/src/node/application/MADD_MH/MADD_MH.o \
    ...
    $O/src/node/application/TSP_MH/TSP_MH.o \
    ...
    $O/src/node/application/GCF_MH/GCF_MH_MA_Pkt_m.o \
    $O/src/node/application/GCF_MH/GCF_MH_PosPkt_m.o \
    $O/src/node/application/IEMA_MH/IEMA_MH_MA_Pkt_m.o \
    $O/src/node/application/IEMA_MH/IEMA_MH_PosPkt_m.o \
    $O/src/node/application/IEMF_MH/IEMF_MH_MA_Pkt_m.o \
    $O/src/node/application/IEMF_MH/IEMF_MH_PosPkt_m.o \
    $O/src/node/application/LCF_MH/LCF_MH_MA_Pkt_m.o \
    $O/src/node/application/LCF_MH/LCF_MH_PosPkt_m.o \
    $O/src/node/application/MADD_MH/MADD_MH_MA_Pkt_m.o \
    $O/src/node/application/MADD_MH/MADD_MH_PosPkt_m.o \
    ...
    $O/src/node/application/TSP_MH/TSP_MH_MA_Pkt_m.o \
    $O/src/node/application/TSP_MH/TSP_MH_PosPkt_m.o \
...
MSGFILES = \
    ...
    src/node/application/GCF_MH/GCF_MH_MA_Pkt.msg \
    src/node/application/GCF_MH/GCF_MH_PosPkt.msg \
    src/node/application/IEMA_MH/IEMA_MH_MA_Pkt.msg \
    src/node/application/IEMA_MH/IEMA_MH_PosPkt.msg \
    src/node/application/IEMF_MH/IEMF_MH_MA_Pkt.msg \
    src/node/application/IEMF_MH/IEMF_MH_PosPkt.msg \
    src/node/application/LCF_MH/LCF_MH_MA_Pkt.msg \
    src/node/application/LCF_MH/LCF_MH_PosPkt.msg \
    src/node/application/MADD_MH/MADD_MH_MA_Pkt.msg \
    src/node/application/MADD_MH/MADD_MH_PosPkt.msg \
    ...
    src/node/application/TSP_MH/TSP_MH_MA_Pkt.msg \
    src/node/application/TSP_MH/TSP_MH_PosPkt.msg \
...
clean:
	...
	-rm -f src/node/application/GCF_MH/*_m.cc src/node/application/GCF_MH/*_m.h
	-rm -f src/node/application/IEMA_MH/*_m.cc src/node/application/IEMA_MH/*_m.h
	-rm -f src/node/application/IEMF_MH/*_m.cc src/node/application/IEMF_MH/*_m.h
	-rm -f src/node/application/LCF_MH/*_m.cc src/node/application/LCF_MH/*_m.h
	-rm -f src/node/application/MADD_MH/*_m.cc src/node/application/MADD_MH/*_m.h
	...
	-rm -f src/node/application/TSP_MH/*_m.cc src/node/application/TSP_MH/*_m.h
...
$O/src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.o: src/node/application/EMIP_MIP_MH/EMIP_MIP_MH.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/GCF_MH/GCF_MH.o: src/node/application/GCF_MH/GCF_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/GCF_MH/GCF_MH.h \
  src/node/application/GCF_MH/GCF_MH_PosPkt_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h \
  src/node/application/GCF_MH/GCF_MH_MA_Pkt_m.h
$O/src/node/application/IEMA_MH/IEMA_MH.o: src/node/application/IEMA_MH/IEMA_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/IEMA_MH/IEMA_MH_PosPkt_m.h \
  src/node/application/IEMA_MH/IEMA_MH.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  ...
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/application/IEMA_MH/IEMA_MH_MA_Pkt_m.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/IEMF_MH/IEMF_MH.o: src/node/application/IEMF_MH/IEMF_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/IEMF_MH/IEMF_MH.h \
  src/node/application/VirtualApplication.h \
  src/node/application/IEMF_MH/IEMF_MH_PosPkt_m.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  ...
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/application/IEMF_MH/IEMF_MH_MA_Pkt_m.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/LCF_MH/LCF_MH.o: src/node/application/LCF_MH/LCF_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/VirtualApplication.h \
  src/node/application/LCF_MH/LCF_MH_MA_Pkt_m.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/node/application/LCF_MH/LCF_MH.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/application/LCF_MH/LCF_MH_PosPkt_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/MADD_MH/MADD_MH.o: src/node/application/MADD_MH/MADD_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/MADD_MH/MADD_MH.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/node/application/MADD_MH/MADD_MH_MA_Pkt_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/communication/mac/MacPacket_m.h \
  src/node/application/MADD_MH/MADD_MH_PosPkt_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
...
$O/src/node/application/throughputTest/ThroughputTest.o: src/node/application/throughputTest/ThroughputTest.cc \
  ...
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
$O/src/node/application/TSP_MH/TSP_MH.o: src/node/application/TSP_MH/TSP_MH.cc \
  src/node/resourceManager/ResourceManager.h \
  src/helpStructures/CastaliaModule.h \
  src/node/application/ApplicationPacket_m.h \
  src/node/application/TSP_MH/TSP_MH.h \
  src/node/application/VirtualApplication.h \
  src/node/sensorManager/SensorManagerMessage_m.h \
  src/helpStructures/TimerServiceMessage_m.h \
  src/CastaliaMessages.h \
  src/node/communication/radio/Radio.h \
  src/node/application/TSP_MH/TSP_MH_MA_Pkt_m.h \
  src/node/communication/mac/MacPacket_m.h \
  src/helpStructures/DebugInfoWriter.h \
  src/node/communication/radio/RadioSupportFunctions.h \
  src/node/communication/radio/RadioControlMessage_m.h \
  src/wirelessChannel/WirelessChannelMessages_m.h \
  src/helpStructures/TimerService.h \
  src/node/application/TSP_MH/TSP_MH_PosPkt_m.h \
  src/node/mobilityManager/VirtualMobilityManager.h \
  src/node/resourceManager/ResourceManagerMessage_m.h
